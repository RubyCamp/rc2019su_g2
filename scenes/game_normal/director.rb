...
module GameNormal
  class Director
    ...
    def initialize
      ...
      unagi_img = Image.load("scenes/game_normal/image/unagi.png")
      @unagi = Shittin.new(300, 400, unagi_img)
      amasagi_img = Image.load("scenes/game_normal/image/wakasagi.png")
      @amasagi = Shittin.new(500, 300, amasagi_img)
      shizimi_img = Image.load("scenes/game_normal/image/shizimi.png")
      @shizimi = Shittin.new(300, 500, shizimi_img)
      koi_img = Image.load("scenes/game_normal/image/koi.png")
      @koi = Shittin.new(100, 300, koi_img)
      sirauo_img = Image.load("scenes/game_normal/image/shirauo.png")
      ...
      normal_enemy_img = Image.load("scenes/game_normal/image/teki_harisenbon.png")
      speed_enemy_img = Image.load("scenes/game_normal/image/speed_enemy.png")
      chase_enemy_img = Image.load("scenes/game_normal/image/matz.png")
      @enemys = []
      ...
      player_img = Image.load("scenes/game_normal/image/ocean_kaichu_post.png")
      ...
      @sound = Sound.new("scenes/game_normal/sound/sound.wav")
