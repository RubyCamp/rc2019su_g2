module Opening
  class Director
    ...
    Scene.move_to(:game_easy) if (Input.mouse_pos_x >= 350 && Input.mouse_pos_x <= 550 && Input.mouse_pos_y >= 210 && Input.mouse_pos_y <= 280 && Input.mouse_push?(M_LBUTTON))
    Scene.move_to(:game_normal) if (Input.mouse_pos_x >= 350 && Input.mouse_pos_x <= 550 && Input.mouse_pos_y >= 310 && Input.mouse_pos_y <= 380 && Input.mouse_push?(M_LBUTTON))
    Scene.move_to(:game_hard) if (Input.mouse_pos_x >= 350 && Input.mouse_pos_x <= 550 && Input.mouse_pos_y >= 410 && Input.mouse_pos_y <= 480 && Input.mouse_push?(M_LBUTTON))
